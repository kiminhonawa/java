...
public class DiaryCreateFrame extends JFrame {
	...
	public static void showDiaryCreateFrame(Component parent, ContactMain app) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DiaryCreateFrame frame = new DiaryCreateFrame(parent, app);
	 ...
	 * Create the frame.
	 */
	public DiaryCreateFrame(Component parent, ContactMain app) {
		this.parent = parent;
		this.app = app;
	...
	public void initialize() {
		...
		textName.setBounds(92, 18, 205, 45);
		panel.add(textName);
		textName.setColumns(10);
		
		lblPhone = new JLabel("내용:");
		...
		textPhone.setBounds(72, 69, 476, 437);
		panel.add(textPhone);
