...
public class ExampleController {
    ...
    @PostMapping("/ex3")
    public String getParamEx2(@RequestParam(name = "username") String name, int age) {
    ...
    public String getParamEx3(UserDto user) {
    	...
    	// 3. 요청 파라미터들의 이름으로 UserDto setter 메서드를 찾아서 호출..
    ...
    public String forwardTest() {
    	...
    	//컨트롤러 메서드에서 다른 페이지(요청주소)로 forward하는 방법:
