...
// 인터페이스가 가질 수 있는 멤버들 - Java 7, 9, 9 이후
// 1. [public static final]생략 가능 필드
// 2. [public abstract] 생략 가능 메서드: (하위)클래스에서 구현하는 것을 목적으로 하는 메서드.
// 3. [public] default 메서드: body가 구현된 메서드. Java 8 버전부터 사용 가능.
// -> 인터페이스를 구현하는 (하위) 클래스의 객체를 생성한 수에 사용하는 메서드.
// 4. [public] static 메서드: body가 구현된 static 메서드. Java 8 버전부터 가능.
// -> 객체 생성 없이 인터페이스 이름 또는 구현 (하위) 클래스 이름으로 접근해서 사용하는 메서드.
// 5. private static 메서드: body가 구현된 private static 메서드. Java9 버전부터 가능.
// -> default 메서드와 public static 메서드 안에서만 사용하기 위한 메서드.
