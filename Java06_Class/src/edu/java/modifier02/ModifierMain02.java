...
// 2. 다른 패키지에 있는 클래스는 
// - import 선언문을 작성하고 변수 선언에서 사용할 수 있음.
// - import 선언문없이, 패키지를 포함한 클래스 전체 이름(full name)을 변수 선언과 생성자 호출에서 사용.
